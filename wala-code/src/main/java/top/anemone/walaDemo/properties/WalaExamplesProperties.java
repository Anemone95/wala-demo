 ...
 */
package top.anemone.walaDemo.properties;
...
public final class WalaExamplesProperties {
  ...
  public static final String PROPERTY_FILENAME = "src/main/resources/wala.examples.properties"; // $NON-NLS-1$
  ...
  public static Properties loadProperties() {
    ...
    try {
      ...
      File targetFile = new File(p.getProperty("output_dir"));
